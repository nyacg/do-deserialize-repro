...
The full evidence trail behind the reproduction, in the order it was
discovered — including the theories that were tested and killed along the
way. The current, share-ready reproduction lives in [README.md](README.md).
Sections marked SUPERSEDED or CONCLUDED are kept because they document
eliminations Cloudflare may want to verify.
...
## Cold-start probe (CONCLUDED 2026-08-03 — negative; worker deleted 2026-08-06)
...
## REPRODUCED ON DEMAND (2026-08-06) — now the README headline; original notes below
...
## Reproduce in production (SUPERSEDED — rollout-detector framing, kept for history)
...
## Upstream ask (SUPERSEDED by the on-demand trigger — see README)
